class AppString {
  ...
  static const String prayerTimeMethodDescription = 'Пожалуйста, уточняйте, какой метод вычисления времени молитв используется в вашей местности и, если он доступен в приложении, то выбирайте его. Обязательно настраивайте часовой пояс под вашу местность. Разница в несколько минут с местным расписанием не говорит о том, что вычисление неправильное, но вы можете отрегулировать минуты вручную в настройках.';
  static const String qiblaDegrees = 'Направление киблы';
  static const String qiblaInfo = 'Поскольку мы стремимся избегать в наших приложениях запроса любых разрешений, доступа к вашему компасу у приложения нет. Но вам предоставлен градус направления к Кибле в соответствии с тем городом, который выбран в настройках. Вы можете воспользоваться любым компасом и, сверившись с градусом направления, указанным выше, определить направление к Кибле.';
 ...
 static const List<String> dailyTexts = [
  ...
  static const String allNumbers = 'Общее количество:';
