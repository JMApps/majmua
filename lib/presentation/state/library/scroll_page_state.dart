...
class ScrollPageState extends ChangeNotifier {
  final _mainScrollStates = Hive.box(AppStringConstraints.keyMainScrollStatesBox);
  ...
  void _toTop() {
    _scrollController.animateTo(0, duration: Duration(milliseconds: 360), curve: Curves.easeIn).then((_) {
