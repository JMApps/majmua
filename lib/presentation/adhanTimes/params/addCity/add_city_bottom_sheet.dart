          ...
          builder: (BuildContext context, InputAddCityState inputState, _) {
            return Column(
              ...
              children: [
                ...
                Form(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      errorText: inputState.getInputLongitude
                          ? appLocale.inputLongitude
                          : null,
                    ),
                ...
                ParamsDescRichText(firstText: '${appLocale.country}: ', secondText: appLocale.countryName),
                ParamsDescRichText(firstText: '${appLocale.city}: ', secondText: appLocale.cityName),
                ParamsDescRichText(firstText: appLocale.latitude, secondText: '21.392425'),
                ParamsDescRichText(firstText: appLocale.longitude, secondText: '39.857970'),
                FilledButton.tonal(
                  onPressed: () {
