...
class DatabaseQuestions {
  static final DatabaseQuestions _instance = DatabaseQuestions.internal();

  factory DatabaseQuestions() => _instance;
  static Database? _db;
  ...
  Future<Database> initializeDatabase() async {
    ...
    String dbPath = join(documentDirectory!.path, 'questions.db');
    var exists = await databaseExists(dbPath);

    // String dbDeletePath = join(documentDirectory.path, 'questions.db');
